...
double Test6()
{
    ...
    if (cat2.Boycott("Sammy Hagar"))
    {
        ...
        {
            score += 0.5;
            cout << endl << "You go point 3" << endl;
        }
        if (cat2.Insert(cd_d1) && cat2.Count() == 3 && cat2.Find(cd_d1) == 2)
        {
            score += 0.5;
            cout << endl << "You go point 4" << endl;
        }
    }
    
    int i;
    cout << cat2.Count() << endl;
    for(i=0;i<cat2.numcds;i++)
    {
        cout << cat2.cds[i].GetArtist() << " ";
        cout << cat2.cds[i].GetAlbum() << std::endl;
    }
    ...
    if (cat3.Boycott("Sammy Hagar"))
    {
        ...
        {
            score += 0.5;
            cout << endl << "You go point 5" << endl;
        }
        if (cat3.Insert(cd_a3) && cat3.Count() == 1 && cat3.Find(cd_a3) == 0)
        {
            score += 0.5;
            cout << endl << "You go point 6" << endl;
        }
    }
