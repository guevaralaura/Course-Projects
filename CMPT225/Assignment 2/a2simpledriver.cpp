...
// Author:      Mackenzie Higa & Homam Maklawi / Geoffrey Tien
...
void CCQTest()
{
  ...
  ccq.Service();
        cout << "\nsize after service1 = " << ccq.Size() << endl;
  ccq.MoveUp(3);
        cout << "\nsize after moveup 3 = " << ccq.Size() << endl;
  ccq.MoveUp(2);
        cout << "\nsize after moveup 2 = " << ccq.Size() << endl;
  ccq.MoveDown(2);
    cout << "\nsize movedown 2 = " << ccq.Size() << endl;
